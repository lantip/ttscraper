...
def main(driver_location="./chromedriver", driver=None, has_driver=False):
    ...
    parser.add_argument("--tipe", help="type: username or tag", type=str, default="username")
    ...
    scraper.start(driver, args.username, tipe=args.tipe, folder=args.location, delay=args.delay)
